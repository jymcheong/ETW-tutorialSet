...
ETW allows you to trigger actions on the endpoint instantly—either directly from events or after light on-device correlation—avoiding the need to send a firehose of data to a backend.  
...
## What's Next?
The next entry in this series will be on **Reusable Helper Class**. We will cover:
